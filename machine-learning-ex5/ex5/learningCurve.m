...
for i = 1:m
	for j = 1:50
		...
		[theta] = trainLinearReg(X(randP,:), y(randP), 0.01);
		[et, grad] = linearRegCostFunction(X(randP,:), y(randP), theta, 0);
		[ev, grad] = linearRegCostFunction(Xval(randP,:), yval(randP), theta, 0);
